...
export const translations = {
  en: {
    ...
    // Step 0: Setup
    step0Title: 'Step 0: Who is this for & Select Language 💌',
    ...
    uploadMediaTitle: 'Upload Photo or Video',
    uploadMediaHint: 'Drag & drop or click to browse (max 50 MB)',
    ...
    secretNoteLabel: '🔒 Secret Note',
    secretNoteHint: '(sibling must click to reveal)',
    secretNotePlaceholder: 'Your secret message or inside joke…',
    addToVaultBtn: 'Add to Vault',
    memoriesAddedCount: 'Memories Added',
    noDateText: 'No date',
    hasSecretNoteTooltip: 'Has secret note',
  ...
  hinglish: {
    ...
    senderNamePlaceholder: 'Jaise: Alex',
    recipientNameLabel: "Bhai/Behen Ka Naam (Recipient) *",
    recipientNamePlaceholder: 'Jaise: Sarah',
    ...
    uploadMediaTitle: 'Photo ya Video Upload Karo',
    uploadMediaHint: 'Drag & drop karo ya browse karke select karo (max 50 MB)',
    mediaReady: '✅ Media Ready hai!',
    titleLabel: 'Title *',
    titlePlaceholder: 'Maggi Ki Chori 🍝',
    dateLabel: 'Tareekh / Date',
    storyLabel: 'Kahaani / Story',
    storyPlaceholder: 'Iss yaad ki poori story likho…',
    secretNoteLabel: '🔒 Secret Note (Chhupa Hua Message)',
    secretNoteHint: '(Bhai/behen ko click karke unlock karna padega)',
    secretNotePlaceholder: 'Ek secret message ya inside joke likho…',
    addToVaultBtn: 'Vault me Add Karo',
    memoriesAddedCount: 'Yaadein Added',
    noDateText: 'Koyi date nahi',
    hasSecretNoteTooltip: 'Secret note hai',
